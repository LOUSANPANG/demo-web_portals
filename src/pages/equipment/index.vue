...
watchEffect(async () => {
  ...
  currentEquipments.value = [
    { id: 1, title: '铝合金单柱式升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/lvhejindanzhushi.png' },
    { id: 2, title: '履带式剪叉升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/fudaishijiancha.png' },
    { id: 3, title: '双柱铝合金升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/shuangzhulvhejin.png' },
    { id: 4, title: '套筒式升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/taotongshi.png' },
    { id: 5, title: '拖车曲臂式升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/tuochequbishi.png' },
    { id: 6, title: '登车桥', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/dengcheqiao.png' },
    { id: 7, title: '卸货平台', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/xiehuopingtai.png' },
    { id: 8, title: '移动式剪叉升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/yidongshijiancha.png' },
    { id: 9, title: '自行剪叉式升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/zixingjianchashi.png' },
    { id: 10, title: '自行曲臂式升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/zixingqubishi.png' },
    { id: 11, title: '自行桅杆式升降机', workHeight: '44.44m', workWidth: '25.60m', workLoad: '300kg/454kg', imgUrl: '/images/equipment/zixingguiganshi.png' },
  ]
})
</script>
...
<template>
  <PageLayout>
    <div class="h-75vh w-full flex flex-col justify-between">
      <!-- 搜索、筛选 -->
      <!-- PC -->
        ...
        <div v-if="filterModal" class="fixed right-0 top-0 z-100 h-vh w-vw bg-black/10" @click="filterModal = false">
          <div class="relative h-full w-full">
            <div class="absolute right-0 top-0 z-1 box-border h-full w-80% rounded-l-lg bg-white px-4 py-4 shadow" @click.stop="() => {}">
              <div class="i-carbon-close-large absolute right-4 top-4 z-5 h-8 w-8 text-orange-400" @click="filterModal = false" />
